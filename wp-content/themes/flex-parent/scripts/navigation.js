...
// Show the dropdown
/**
 * Displays a dropdown menu with the given submenu content at a specified position.
 *
 * @param {string} submenu - The HTML content of the submenu to be displayed.
 * @param {object} position - The position of the dropdown menu relative to its parent element.
 * @param {string} side - The side of the dropdown menu where the submenu will appear.
 *
 * @return undefined
 */
 ...
 *
 * This method prepares the dropdown animation, sets the transition properties for the animation,
 * and hides the dropdown menu by removing the "visible" class.
 *
 * @param {jQuery} dropdown - The jQuery object representing the dropdown menu element.
 * @param {string} perspective_origin - The perspective origin value for the dropdown animation.
 * @returns {void}
 */
...
/**
 * Updates language switcher links in the header.
 *
